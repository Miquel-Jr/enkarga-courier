...
async function obtenerDatosProveedorXID(id) {
  return new Promise(function (resolve, reject) {
    $.ajax({
      url: "../EC-BackEnd/Controlador/ModMaestros/Controlador_Proveedor/Controlador_CargarProveedor.php",
      type: "POST",
      data: { _idProveedor: id },
      dataType: "json",
      success: function (datos) {
        resolve(datos); // Resuelve la promesa con los datos
      },
