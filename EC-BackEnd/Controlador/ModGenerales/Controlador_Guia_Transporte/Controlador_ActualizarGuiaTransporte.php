...
if (isset($_POST['_idGuiaTransporte']) && isset($_POST['_idGuia'])) {

  //GUARDAR PARAMETROS EN VARIABLES

  $idGuiaTransporte = $_POST['_idGuiaTransporte'];
  ...
  $consulta = $Model_Guia_Transporte->actualizarGuiaTransporte($idGuiaTransporte, $idGuia, $proveedor, $numeroGuia, $idEstadoGuiaTransporte, $numeroFactura, $origen, $destino, $descripcion, $cantidadBulto, $observaciones, $reparto, $subtotal, $igv, $total, $fechaDespacho, $tipoTransporte);

  if ($consulta) {
    $msg = array(
      "response" => 1,
      "message" => "Guia Transporte actualizada correctamente"
    );
