...
if (isset($_POST['_idNotaCredito'])) {
  ...
  if ($Model_Nota_Credito->actualizarNotaCredito($idFactura, $fechaNotaCredito, $serieNotaCredito, $numeroNotaCredito, $baseImponible, $igv, $total, $idNotaCredito)) {

    $msg = array(
      "response" => 1,
      "message" => "Nota de credito actualizada correctamente"
    );
