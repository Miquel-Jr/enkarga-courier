...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-08-2024 a las 14:08:55
...
--
-- Creación: 13-08-2024 a las 11:48:59
--
...
INSERT INTO `acceso` (`id_acceso`, `clientes`, `proveedor`, `personal`, `operaciones`, `contabilidad`, `id_personal`, `fecha_registro`) VALUES
(1, 1, 1, 1, 1, 1, 1, '2024-06-24 10:16:33'),
(2, 0, 0, 0, 1, 0, 4, '2024-06-24 11:22:09');
...
--
-- Creación: 13-08-2024 a las 11:17:35
--
...
--
-- Creación: 13-08-2024 a las 11:46:26
--

DROP TABLE IF EXISTS `cliente_sucursal`;
CREATE TABLE `cliente_sucursal` (
  `id_cliente_sucursal` int(11) NOT NULL COMMENT 'Id de cliente sucursal',
  `id_cliente` int(11) NOT NULL COMMENT 'Id Cliente',
  `ruc` varchar(20) NOT NULL COMMENT 'Ruc de la sucursal',
  `razon_social` varchar(100) NOT NULL COMMENT 'Razon Social de la sucursal',
  `id_distrito` int(11) NOT NULL COMMENT 'Id distrito',
  `direccion` text NOT NULL COMMENT 'Direccion de la sucursal',
  `id_estado` int(11) NOT NULL DEFAULT 1 COMMENT 'Id estado de la sucursal',
  `fecha_registro` timestamp NOT NULL DEFAULT current_timestamp() COMMENT 'Fecha de registro'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='TABLA CLIENTE SUCURSAL';

--
-- RELACIONES PARA LA TABLA `cliente_sucursal`:
--   `id_cliente`
--       `cliente` -> `id_cliente`
--   `id_estado`
--       `estado` -> `id_estado`
...
--
-- Creación: 13-08-2024 a las 11:49:51
--
...
--
-- RELACIONES PARA LA TABLA `configuracion_empresa`:
--   `id_distrito`
--       `distrito` -> `id_distrito`
--

--
-- Truncar tablas antes de insertar `configuracion_empresa`
--
...
--
-- Creación: 13-08-2024 a las 11:50:16
--
...
INSERT INTO `distrito` (`id_distrito`, `descripcion`, `id_provincia`, `id_departamento`) VALUES
...
--
-- RELACIONES PARA LA TABLA `estado_factura`:
--

--
-- Truncar tablas antes de insertar `estado_factura`
--

TRUNCATE TABLE `estado_factura`;
--
...
--
-- RELACIONES PARA LA TABLA `estado_guia`:
--

--
-- Truncar tablas antes de insertar `estado_guia`
--

TRUNCATE TABLE `estado_guia`;
--
-- Volcado de datos para la tabla `estado_guia`
--

INSERT INTO `estado_guia` (`id_estado_guia`, `descripcion`, `detalle`) VALUES
(1, 'REGISTRADO', 'Registrado en el portal web'),
(2, 'PREPARADO', 'Productos cargados en transportista'),
(3, 'EN TRANSITO', 'En transito al destino'),
(4, 'RECIBIDO', 'Recibido por el personal de entrega'),
(5, 'ENTREGADO', 'Entregado al cliente'),
(6, 'FACTURADO', 'Facturado por el usuario'),
(7, 'CANCELADO', 'Cancelado por el cliente/usuario');
...
--
-- Creación: 13-08-2024 a las 11:53:37
--
...
--
-- RELACIONES PARA LA TABLA `estado_guia_transporte`:
--

--
-- Truncar tablas antes de insertar `estado_guia_transporte`
--

TRUNCATE TABLE `estado_guia_transporte`;
--
-- Volcado de datos para la tabla `estado_guia_transporte`
--

INSERT INTO `estado_guia_transporte` (`id_estado_guia_transporte`, `descripcion`) VALUES
(1, 'PENDIENTE DE PAGO'),
(2, 'PAGADO');
...
CREATE TABLE `factura` (
  ...
  `id_cliente_sucursal` int(11) NOT NULL COMMENT 'Id cliente sucursal',
...
--   `id_cliente_sucursal`
--       `cliente_sucursal` -> `id_cliente_sucursal`
--
...
--
-- RELACIONES PARA LA TABLA `factura_deposito`:
--   `id_factura`
--       `factura` -> `id_factura`
--
...
--
-- Creación: 13-08-2024 a las 11:57:35
--
...
CREATE TABLE `guia` (
  ...
  `orden_compra` varchar(100) NOT NULL COMMENT 'Orden de compra',
  ...
  `id_sucursal_remitente` int(11) NOT NULL COMMENT 'Id de sucursal remitente',
  `direccion_remitente` varchar(100) NOT NULL COMMENT 'Direccion remitente',
  `id_sucursal_destinatario` int(11) NOT NULL COMMENT 'Id sucursal destinatario',
  `direccion_destinatario` varchar(100) NOT NULL COMMENT 'Direccion destinatario',
...
--   `id_usuario`
--       `personal` -> `id_personal`
--   `id_sucursal_remitente`
--       `cliente_sucursal` -> `id_cliente_sucursal`
--   `id_sucursal_destinatario`
--       `cliente_sucursal` -> `id_cliente_sucursal`
--
...
--
-- RELACIONES PARA LA TABLA `guia_detalle`:
--   `id_guia`
--       `guia` -> `id_guia`
--
...
--
-- Estructura de tabla para la tabla `guia_factura`
--
-- Creación: 13-08-2024 a las 11:17:35
--

DROP TABLE IF EXISTS `guia_factura`;
CREATE TABLE `guia_factura` (
  `id_guia_factura` int(11) NOT NULL COMMENT 'Id guia factura',
  `id_factura` int(11) NOT NULL COMMENT 'Id factura',
  `id_guia` int(11) NOT NULL COMMENT 'Id guia',
  `fecha_registro` timestamp NOT NULL DEFAULT current_timestamp() COMMENT 'Fecha de registro'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='TABLA GUIA FACTURA';

--
-- RELACIONES PARA LA TABLA `guia_factura`:
--   `id_guia`
--       `guia` -> `id_guia`
--   `id_factura`
--       `factura` -> `id_factura`
...
--
-- Creación: 13-08-2024 a las 11:58:21
--
...
CREATE TABLE `guia_transporte` (
  ...
  `id_guia` int(11) NOT NULL COMMENT 'Id guia ',
  `id_proveedor` int(11) NOT NULL COMMENT 'Id proveedor transportista',
...
--
-- RELACIONES PARA LA TABLA `guia_transporte`:
--   `id_guia`
--       `guia` -> `id_guia`
--   `id_proveedor`
--       `proveedor` -> `id_proveedor`
--   `id_estado_guia_transporte`
--       `estado_guia_transporte` -> `id_estado_guia_transporte`
--
...
--
-- RELACIONES PARA LA TABLA `nota_credito`:
--   `id_factura`
--       `factura` -> `id_factura`
--
...
--
-- Creación: 13-08-2024 a las 11:58:47
--
...
INSERT INTO `perfil` (`id_perfil`, `perfil`, `descripcion`, `id_estado`, `fecha_registro`) VALUES
(1, 'Administrador', 'Perfil del administrador del sistema', 1, '2023-11-30 04:56:12'),
(2, 'Ejecutivo', 'Ejecutivo de ventas', 1, '2024-03-16 13:21:19'),
(3, 'Mensajeria', 'Perfil de entrega', 1, '2024-03-16 13:21:19'),
(4, 'Sin perfil', 'Usuario sin perfil', 1, '2024-03-17 00:20:44');
...
--
-- Creación: 13-08-2024 a las 11:59:16
--
...
--
-- Creación: 13-08-2024 a las 11:59:37
--
...
CREATE TABLE `proveedor` (
  ...
  `telefono` varchar(20) DEFAULT NULL COMMENT 'Telefono del proveedor',
  `celular` varchar(20) DEFAULT NULL COMMENT 'Celular del proveedor',
...
--
-- Creación: 13-08-2024 a las 11:59:53
--
...
INSERT INTO `provincia` (`id_provincia`, `descripcion`, `id_departamento`) VALUES
('0101', 'Chachapoyas', '01'),
('0102', 'Bagua', '01'),
('0103', 'Bongará', '01'),
...
--
-- RELACIONES PARA LA TABLA `seguimiento_guia`:
--   `id_guia`
--       `guia` -> `id_guia`
--   `id_usuario`
--       `personal` -> `id_personal`
...
--
-- Creación: 13-08-2024 a las 12:00:50
--
...
INSERT INTO `usuario` (`id_personal`, `usuario`, `clave`, `id_perfil`, `id_estado`) VALUES
(1, 'admin', '123456', 1, 1),
(4, 'jacaceres', '12121212', 3, 1);
...
ALTER TABLE `cliente_sucursal`
  ADD PRIMARY KEY (`id_cliente_sucursal`),
...
ALTER TABLE `factura`
  ...
  ADD KEY `FK_CLIENTE_SUCURSAL_ID_CLIENTE_SUCURSAL` (`id_cliente_sucursal`) USING BTREE;
...
ALTER TABLE `guia`
  ...
  ADD KEY `FK_CLIENTE_SUCURSAL_ID_SUCURSAL_REMITENTE` (`id_sucursal_remitente`),
  ADD KEY `FK_CLIENTE_SUCURSAL_ID_SUCURSAL_DESTINATARIO` (`id_sucursal_destinatario`);
...
--
-- Indices de la tabla `guia_factura`
--
ALTER TABLE `guia_factura`
  ADD PRIMARY KEY (`id_guia_factura`),
  ADD KEY `FK_GUIA_ID_GUIA` (`id_guia`),
  ADD KEY `FK_FACTURA_ID_FACTURA` (`id_factura`) USING BTREE;
...
--
ALTER TABLE `cliente`
  MODIFY `id_cliente` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Id cliente';

--
-- AUTO_INCREMENT de la tabla `cliente_sucursal`
--
ALTER TABLE `cliente_sucursal`
  MODIFY `id_cliente_sucursal` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Id de cliente sucursal';
...
--
ALTER TABLE `factura`
  MODIFY `id_factura` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Id de la factura';

--
-- AUTO_INCREMENT de la tabla `factura_deposito`
--
ALTER TABLE `factura_deposito`
  MODIFY `id_factura_deposito` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Id de factura deposito';

--
-- AUTO_INCREMENT de la tabla `guia`
--
ALTER TABLE `guia`
  MODIFY `id_guia` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Id de factura';

--
-- AUTO_INCREMENT de la tabla `guia_detalle`
--
ALTER TABLE `guia_detalle`
  MODIFY `id_guia_detalle` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Id Guia Detalle';

--
-- AUTO_INCREMENT de la tabla `guia_factura`
--
ALTER TABLE `guia_factura`
  MODIFY `id_guia_factura` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Id guia factura';

--
-- AUTO_INCREMENT de la tabla `guia_transporte`
--
ALTER TABLE `guia_transporte`
  MODIFY `id_guia_transporte` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Id Guia de transporte';
...
--
ALTER TABLE `proveedor`
  MODIFY `id_proveedor` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Id proveedor';

--
-- AUTO_INCREMENT de la tabla `seguimiento_guia`
--
ALTER TABLE `seguimiento_guia`
  MODIFY `id_seguimiento_guia` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Id Seguimiento Guia';
...
--
ALTER TABLE `acceso`
  ADD CONSTRAINT `acceso_ibfk_1` FOREIGN KEY (`id_personal`) REFERENCES `personal` (`id_personal`) ON UPDATE CASCADE;
...
--
ALTER TABLE `cliente_sucursal`
  ADD CONSTRAINT `cliente_sucursal_ibfk_1` FOREIGN KEY (`id_cliente`) REFERENCES `cliente` (`id_cliente`) ON UPDATE CASCADE,
  ADD CONSTRAINT `cliente_sucursal_ibfk_2` FOREIGN KEY (`id_estado`) REFERENCES `estado` (`id_estado`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `configuracion_empresa`
--
ALTER TABLE `configuracion_empresa`
  ADD CONSTRAINT `configuracion_empresa_ibfk_1` FOREIGN KEY (`id_distrito`) REFERENCES `distrito` (`id_distrito`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `distrito`
--
ALTER TABLE `distrito`
  ADD CONSTRAINT `distrito_ibfk_1` FOREIGN KEY (`id_provincia`) REFERENCES `provincia` (`id_provincia`) ON UPDATE CASCADE;
...
ALTER TABLE `factura`
  ...
  ADD CONSTRAINT `factura_ibfk_3` FOREIGN KEY (`id_cliente_sucursal`) REFERENCES `cliente_sucursal` (`id_cliente_sucursal`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `factura_deposito`
--
ALTER TABLE `factura_deposito`
  ADD CONSTRAINT `factura_deposito_ibfk_1` FOREIGN KEY (`id_factura`) REFERENCES `factura` (`id_factura`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `guia`
--
ALTER TABLE `guia`
  ADD CONSTRAINT `guia_ibfk_1` FOREIGN KEY (`id_estado_guia`) REFERENCES `estado_guia` (`id_estado_guia`) ON UPDATE CASCADE,
  ADD CONSTRAINT `guia_ibfk_3` FOREIGN KEY (`id_cliente`) REFERENCES `cliente` (`id_cliente`) ON UPDATE CASCADE,
  ADD CONSTRAINT `guia_ibfk_6` FOREIGN KEY (`id_usuario`) REFERENCES `personal` (`id_personal`) ON UPDATE CASCADE,
  ADD CONSTRAINT `guia_ibfk_7` FOREIGN KEY (`id_sucursal_remitente`) REFERENCES `cliente_sucursal` (`id_cliente_sucursal`) ON UPDATE CASCADE,
  ADD CONSTRAINT `guia_ibfk_8` FOREIGN KEY (`id_sucursal_destinatario`) REFERENCES `cliente_sucursal` (`id_cliente_sucursal`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `guia_detalle`
--
ALTER TABLE `guia_detalle`
  ADD CONSTRAINT `guia_detalle_ibfk_1` FOREIGN KEY (`id_guia`) REFERENCES `guia` (`id_guia`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `guia_factura`
--
ALTER TABLE `guia_factura`
  ADD CONSTRAINT `guia_factura_ibfk_1` FOREIGN KEY (`id_guia`) REFERENCES `guia` (`id_guia`) ON UPDATE CASCADE,
  ADD CONSTRAINT `guia_factura_ibfk_2` FOREIGN KEY (`id_factura`) REFERENCES `factura` (`id_factura`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `guia_transporte`
--
ALTER TABLE `guia_transporte`
  ADD CONSTRAINT `guia_transporte_ibfk_1` FOREIGN KEY (`id_guia`) REFERENCES `guia` (`id_guia`) ON UPDATE CASCADE,
  ADD CONSTRAINT `guia_transporte_ibfk_2` FOREIGN KEY (`id_proveedor`) REFERENCES `proveedor` (`id_proveedor`) ON UPDATE CASCADE,
  ADD CONSTRAINT `guia_transporte_ibfk_3` FOREIGN KEY (`id_estado_guia_transporte`) REFERENCES `estado_guia_transporte` (`id_estado_guia_transporte`) ON UPDATE CASCADE;
...
--
ALTER TABLE `perfil`
  ADD CONSTRAINT `perfil_ibfk_1` FOREIGN KEY (`id_estado`) REFERENCES `estado` (`id_estado`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `personal`
--
ALTER TABLE `personal`
  ADD CONSTRAINT `personal_ibfk_1` FOREIGN KEY (`id_estado`) REFERENCES `estado` (`id_estado`) ON UPDATE CASCADE,
  ADD CONSTRAINT `personal_ibfk_2` FOREIGN KEY (`tipo_documento`) REFERENCES `tipo_documento` (`tipo_documento`) ON UPDATE CASCADE,
  ADD CONSTRAINT `personal_ibfk_3` FOREIGN KEY (`id_distrito`) REFERENCES `distrito` (`id_distrito`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `proveedor`
--
ALTER TABLE `proveedor`
  ADD CONSTRAINT `proveedor_ibfk_1` FOREIGN KEY (`id_estado`) REFERENCES `estado` (`id_estado`) ON UPDATE CASCADE,
  ADD CONSTRAINT `proveedor_ibfk_2` FOREIGN KEY (`id_distrito`) REFERENCES `distrito` (`id_distrito`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `provincia`
--
ALTER TABLE `provincia`
  ADD CONSTRAINT `provincia_ibfk_1` FOREIGN KEY (`id_departamento`) REFERENCES `departamento` (`id_departamento`) ON UPDATE CASCADE;
...
ALTER TABLE `seguimiento_guia`
  ...
  ADD CONSTRAINT `seguimiento_guia_ibfk_2` FOREIGN KEY (`id_usuario`) REFERENCES `personal` (`id_personal`) ON UPDATE CASCADE;
...
ALTER TABLE `usuario`
  ...
  ADD CONSTRAINT `usuario_ibfk_2` FOREIGN KEY (`id_perfil`) REFERENCES `perfil` (`id_perfil`) ON UPDATE CASCADE,
  ADD CONSTRAINT `usuario_ibfk_3` FOREIGN KEY (`id_personal`) REFERENCES `personal` (`id_personal`) ON UPDATE CASCADE;
