...
if (isset($_POST['_idFactura'])) {
  ...
  $consulta = $Model_Factura->actualizarFactura($idFactura, $serie, $numero, $cliente, $fechaVencimiento, $tipoCredito, $ordenServicio, $baseImponible, $igv, $subtotal, $detraccion, $total);
