...
if (isset($_POST['_ruc']) && isset($_POST['_razonSocial'])) {
  ...
  if ($Model_Proveedor->registrarProveedor($ruc, $razonSocial, $correo, $distrito, $direccion, $telefonoEmpresa, $celularEmpresa)) {
    $msg = array(
      "response" => 1,
